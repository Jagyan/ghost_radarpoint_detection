...
import sys
sys.path.append('/home/mahapatro/pointnet.pytorch/')
...
for i,data in enumerate(test_loader, 0):
    ...
    for j in range(len(pred)):
        ...
        if "aug" not in filepath[j]:
            np.savetxt('/home/mahapatro/pointnet.pytorch/predicted_data/'+filepath[j][-39:-4]+'_predicted.txt', predicted_data, header="X Y Z V_r Mag Label Pred", delimiter=" ", comments='')
        else:
            np.savetxt('/home/mahapatro/pointnet.pytorch/predicted_data/'+filepath[j][-43:-4]+'_predicted.txt', predicted_data, header="X Y Z V_r Mag Label Pred", delimiter=" ", comments='')
